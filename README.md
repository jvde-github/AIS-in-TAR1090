...
```
Assuming your AIS-catcher server is running at 192.168.1.113, the data will be accessible at http://192.168.1.113:8100/geojson. This GeoJSON data can be effectively visualized using libraries like OpenLayers. Check out the index.html file in your codebase for reference. To make it work with your specific setup, edit the line defining server_aiscatcher.
